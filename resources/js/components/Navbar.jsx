      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between py-3">
              ...
              >
                <path
                  ...
                  d="M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 
                     0 012-2h14a2 2 0 012 2v8a2 2 0 
                     01-2 2h-5l-5 5v-5z"
                />
              </svg>
            </div>
          ...
          <div className="flex items-center space-x-6">
            {/* <button className="font-medium text-gray-800 hover:text-indigo-900">
              Buat Event
            </button>
            <button className="font-medium text-gray-800 hover:text-indigo-900">
              Bantuan
            </button> */}
            <button className="px-5 py-2 font-medium text-black bg-green-300 rounded-full hover:bg-green-400">
              Login
            </button>
          </div>
        </div>
